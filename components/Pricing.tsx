...
function PricingPlans() {
    ...
    return (
        <>
            <div className="text-center  cursor-pointer text-xl mt-6" >
            ...
            <div className='grid md:grid-cols-3 grid-cols-1 mt-2 w-full gap-8'>
                ...
                <div className="card w-full mt-6 bg-white px-3 rounded-md shadow-xl hover:shadow-2xl">
                ...
                <div className="card w-full mt-6 bg-white px-3 rounded-md shadow-xl hover:shadow-2xl">
                    <div className="card-body pt-12 pb-16 items-center  ">
                        ...
                        <button className="btn btn-sm mt-8 btn-primary normal-case w-full" >Subscribe</button>
                        <ul className="text-left mt-4">
                            {
                ...
                <div className="card w-full mt-6 bg-white px-3 rounded-md shadow-xl hover:shadow-2xl">
                    <div className="card-body pt-12 pb-16 items-center  ">
                        ...
                        <button className="btn btn-sm mt-8 btn-outline normal-case w-full" >Subscribe</button>
                        <ul className="text-left mt-4">
                            {
